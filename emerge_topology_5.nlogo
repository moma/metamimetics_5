...
to go
  ...
  if selective-pressure?[ifelse timescale = "months" [set-life-distribution-USA2007-months][set-life-distribution-USA2007] ]
...
to set-life-distribution-USA2007-months
  ask turtles [set life-distribution (list
