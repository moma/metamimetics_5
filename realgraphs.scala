...
ExplorationTask (
    ...
    (filein in List("jazzFinal.graphml", "polblogsFinal.graphml","politicsFinal.graphml","schoolFinal.graphml","netscienceFinal.graphml","PGPFinal.graphml","emailFinal.graphml"))x
    (SobolSampling(
    200, 
...
val ex =  exploration  -< (model    hook ( fileHook , populHook , coopHook, agesHook) on env4)  start
