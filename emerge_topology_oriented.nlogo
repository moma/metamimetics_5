...
;;      set theta_1 random-float 1.0
 ...
 ;     set weighting-history random-float 1
  ...
  ask turtles [
    ...
    establish-color]
  init-age-USA2007
  if timescale = "months" [ask turtles[set-life-distribution-USA2007-months]]
  if timescale = "years" [ask turtles[set-life-distribution-USA2007]]
    if timescale = "months-erick" [ask turtles[set-life-distribution-USA2007-months-erick]]
...
to set-cumulative-score
  ...
  ask turtles [
    ...
    ifelse cumulative-score = 0 [
      
     
     set cumulative-score  inst-score * (1 - item x life-distribution)
      ]
    [
...
true
false
"if timescale = \"years\" [set-plot-x-range 0 100]" ""
PENS
